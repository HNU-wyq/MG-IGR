...
% Surface example, consisting of "2 isogeometric elements", with initial
% degrees p = 2, q = 2, and then raised to p = 10, q = 7.
...
% Do knot insertion:
d_xi = 1; % Raise p to p + d_xi
[B,Xi] =DegElevXi( B,p,Xi,d_xi );
d_eta = 1; % Raise q to q + d_eta
[B,Eta] = DegElevEta( B,q,Eta,d_eta );
