...
B{3,1,1} = [0     rr-t      0        1];
B{3,1,2} = [0     rr-t+du   -du      1];
B{3,1,3} = [0      rr-t+du   -dy+du   1];
B{3,1,4} = [0     rr-t     -dy      1];
B{3,1,5} = [0     rr-t-du   -dy-du   1];
B{3,1,6} = [0      rr-t-du   -2*dy+du 1];
B{3,1,7} = [0      rr-t     -2*dy    1];
B{3,1,8} = [0      rr-t+du   -2*dy-du 1];
B{3,1,9} = [0      rr-t+du   -3*dy+du 1];
B{3,1,10}= [0      rr-t     -1.2    1];

B{3,2,1} = [0    rr+t   0        1];
B{3,2,2} = [0  rr+t+du    -du      1];
B{3,2,3} = [0  rr+t+du    -dy+du   1];
B{3,2,4} = [0    rr+t    -dy      1];
B{3,2,5} = [0  rr+t-du    -dy-du   1];
B{3,2,6} = [0  rr+t-du    -2*dy+du 1];
B{3,2,7} = [0    rr+t    -2*dy    1];
B{3,2,8} = [0  rr+t+du    -2*dy-du 1];
B{3,2,9} = [0  rr+t+du    -3*dy+du 1];
B{3,2,10}= [0    rr+t    -1.2   1];

B{4,1,1} = [-2*(rr-t)    rr-t   0        s];
...
B{4,1,10}= [-2*(rr-t)    rr-t    -1.2    s];

B{4,2,1} = [-2*(rr+t)    rr+t   0        s];
